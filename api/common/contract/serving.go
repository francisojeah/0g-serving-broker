...
//
// Solidity: function getAccount(address user, address provider) view returns((address,address,uint256,uint256,uint256,uint256[2],(uint256,uint256,uint256,bool)[]))
...
//
// Solidity: function getAllAccounts() view returns((address,address,uint256,uint256,uint256,uint256[2],(uint256,uint256,uint256,bool)[])[])
...
//
// Solidity: function getAllServices() view returns((address,string,string,string,uint256,uint256,uint256,string)[] services)
...
//
// Solidity: function getService(address provider, string name) view returns((address,string,string,string,uint256,uint256,uint256,string) service)
...
// AddAccount is a paid mutator transaction binding the contract method 0x850cd14e.
//
// Solidity: function addAccount(address provider, uint256[2] signer) payable returns()
func (_Serving *ServingTransactor) AddAccount(opts *bind.TransactOpts, provider common.Address, signer [2]*big.Int) (*types.Transaction, error) {
	return _Serving.contract.Transact(opts, "addAccount", provider, signer)
}

// AddAccount is a paid mutator transaction binding the contract method 0x850cd14e.
//
// Solidity: function addAccount(address provider, uint256[2] signer) payable returns()
func (_Serving *ServingSession) AddAccount(provider common.Address, signer [2]*big.Int) (*types.Transaction, error) {
	return _Serving.Contract.AddAccount(&_Serving.TransactOpts, provider, signer)
}

// AddAccount is a paid mutator transaction binding the contract method 0x850cd14e.
//
// Solidity: function addAccount(address provider, uint256[2] signer) payable returns()
func (_Serving *ServingTransactorSession) AddAccount(provider common.Address, signer [2]*big.Int) (*types.Transaction, error) {
	return _Serving.Contract.AddAccount(&_Serving.TransactOpts, provider, signer)
}

// AddOrUpdateService is a paid mutator transaction binding the contract method 0x40f5dbbd.
//
// Solidity: function addOrUpdateService(string name, string serviceType, string url, string model, uint256 inputPrice, uint256 outputPrice) returns()
func (_Serving *ServingTransactor) AddOrUpdateService(opts *bind.TransactOpts, name string, serviceType string, url string, model string, inputPrice *big.Int, outputPrice *big.Int) (*types.Transaction, error) {
	return _Serving.contract.Transact(opts, "addOrUpdateService", name, serviceType, url, model, inputPrice, outputPrice)
}

// AddOrUpdateService is a paid mutator transaction binding the contract method 0x40f5dbbd.
//
// Solidity: function addOrUpdateService(string name, string serviceType, string url, string model, uint256 inputPrice, uint256 outputPrice) returns()
func (_Serving *ServingSession) AddOrUpdateService(name string, serviceType string, url string, model string, inputPrice *big.Int, outputPrice *big.Int) (*types.Transaction, error) {
	return _Serving.Contract.AddOrUpdateService(&_Serving.TransactOpts, name, serviceType, url, model, inputPrice, outputPrice)
}

// AddOrUpdateService is a paid mutator transaction binding the contract method 0x40f5dbbd.
//
// Solidity: function addOrUpdateService(string name, string serviceType, string url, string model, uint256 inputPrice, uint256 outputPrice) returns()
func (_Serving *ServingTransactorSession) AddOrUpdateService(name string, serviceType string, url string, model string, inputPrice *big.Int, outputPrice *big.Int) (*types.Transaction, error) {
	return _Serving.Contract.AddOrUpdateService(&_Serving.TransactOpts, name, serviceType, url, model, inputPrice, outputPrice)
}
...
// FilterServiceUpdated is a free log retrieval operation binding the contract event 0x0db73acceaca5aaea345c313a78e828449b1d408b946ff1e9a99d10ce8536081.
//
// Solidity: event ServiceUpdated(address indexed service, string indexed name, string serviceType, string url, uint256 inputPrice, uint256 outputPrice, uint256 updatedAt, string model)
...
// WatchServiceUpdated is a free log subscription operation binding the contract event 0x0db73acceaca5aaea345c313a78e828449b1d408b946ff1e9a99d10ce8536081.
//
// Solidity: event ServiceUpdated(address indexed service, string indexed name, string serviceType, string url, uint256 inputPrice, uint256 outputPrice, uint256 updatedAt, string model)
...
// ParseServiceUpdated is a log parse operation binding the contract event 0x0db73acceaca5aaea345c313a78e828449b1d408b946ff1e9a99d10ce8536081.
//
// Solidity: event ServiceUpdated(address indexed service, string indexed name, string serviceType, string url, uint256 inputPrice, uint256 outputPrice, uint256 updatedAt, string model)
